...
const Page3 = React.createClass({
  render() {
    return (
      <p><Link to="/page2">A link to page 2 should be active</Link>Page3</p>
    );
  }
});
    ...
    return (
      <div>
        <QueueAnim interval={200}>
          <h1 key="1">Page 1</h1>
          <p key="2"><Link to="/page2">A link to page 2 should be active</Link>依次进场</p>
          <p key="3"><Link to="/page2">A link to page 2 should be active</Link>依次进场</p>
  ...
  render() {
    return (
      <div>
        <QueueAnim interval={200}>
          <h1 key="1">Page 2</h1>
          <p key="2"><Link to="/page1">a link to page 1 </Link>我是页面2.</p>
          <p key="3"><Link to="/page1">a link to page 1 </Link>我是页面2.</p>
          <p key="4"><Link to="/page1">a link to page 1 </Link>我是页面2.</p>
          <p key="5"><Link to="/page1">a link to page 1 </Link>我是页面2.</p>
        </QueueAnim>
      </div>
    );
  }
